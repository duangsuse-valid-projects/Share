...
古人写诗写歌来交友、咏志，我们要求全篇背、背了忘。当然这篇文章是不需要 *背诵* 的。（背了又有什么用？何况你们会喷我写的不如古人文绉绉没有背诵价值，逍遥游！）
...
成功和失败之间，数十乃至上百分的差距，就可以直接划出一道全白的分界线？<a nsfw>不是不可以，至少我们还有机器学习不是？（笑）不过学的是垃圾、预测的也是垃圾。</a>
